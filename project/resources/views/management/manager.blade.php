...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('../../../../css/management/manage-food.css">
</head>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <h6>ชื่ออาหาร :</h6>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="ชื่ออาหาร" name="foodname" id="mFoodname" value="" required>
                                            </div>
                                            <h6>หมวดหมู่ :</h6>
                                            <div class="mb-3">
                                                <select class="form-select header-from" aria-label="Default select example" id="mCategory">
                                                    <option value="type" selected>หมวดหมู่</option>
                                                    <option value="dimsum">ติ่มซำ</option>
                                                    <option value="drink">เครื่องดื่ม</option>
                                                </select>
                                            </div>
